      ...
      <div class="row bigData-container" style="margin-top:89px">
        ...
        <div class="new4">
          ...
          <div class="new8">
              ...
              <div class="new9" style="margin-left:138px;background: rgb(152, 152, 152);">BUY ON OPENSEA</div>
          </div>
        </div>
        <div class="new10">
      ...
      <div class="row bigData-container">
        ...
        <div class="new4">
          ...
          <div class="new8" style="width:100%">
              ...
              <div class="new9" style="width:50%;margin-left:25%;margin-top:20px;font-size: 16px;height:44px;line-height:44px;background: rgb(152, 152, 152);">BUY ON OPENSEA</div>
          </div>
        </div>
