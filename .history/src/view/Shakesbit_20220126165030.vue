      ...
      <div class="row bigData-container">
        ...
        <div class="new4">
          <div class="new5" style="width:60%;height:320px;">
            <video style="margin-top:0px;" class="video1" controls autoplay="autoplay" loop muted>
              <source src="@/assets/vi.mp4" type="video/mp4">
            </video>
            <div class="new55" style="padding: 0 14px;">
              ...
              <div class="new7" style="font-size: 14px;margin-top: 10px;">白名單</div>
            </div>
          </div>
