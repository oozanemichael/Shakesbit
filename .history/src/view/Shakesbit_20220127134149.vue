...
export default {
  ...
  methods: {
     countdown() {
      ...
      const end = Date.parse(new Date(('2022-01-27 20:00:00').replace(/-/g)))   
      const end2 = Date.parse(new Date(('2022-01-27 20:00:00').replace(/-/g)))   
      const end3 = Date.parse(new Date(('2022-01-27 20:00:00').replace(/-/g)))   
